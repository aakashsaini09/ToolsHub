...
const Profile = () => {
  ...
  return (
    <>
    <Navbar/>
       <div className="items-center flex flex-col px-5 h-auto bg-gray-900 min-h-[75vh]">
                ...
                ) : (<div className="w-full min-h-[80vh] bg-gray-900 flex justify-center items-center text-3xl text-gray-200 font-serif">Loading...</div>)}
            </div>
    </>
  )
}
